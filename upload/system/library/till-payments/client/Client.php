...
namespace TillPayments\Client;

use TillPayments\Client\CustomerProfile\CustomerData;
use TillPayments\Client\CustomerProfile\DeleteProfileResponse;
use TillPayments\Client\CustomerProfile\GetProfileResponse;
use TillPayments\Client\CustomerProfile\PaymentInstrument;
use TillPayments\Client\CustomerProfile\UpdateProfileResponse;
use TillPayments\Client\Json\ErrorResponse;
use TillPayments\Client\Exception\RateLimitException;
use TillPayments\Client\Schedule\ScheduleData;
use TillPayments\Client\Exception\ClientException;
use TillPayments\Client\Exception\InvalidValueException;
use TillPayments\Client\Exception\TimeoutException;
use TillPayments\Client\Http\CurlClient;
use TillPayments\Client\Http\Response;
use TillPayments\Client\StatusApi\StatusRequestData;
...
use TillPayments\Client\Transaction\Deregister;
use TillPayments\Client\Transaction\Payout;
use TillPayments\Client\Transaction\Preauthorize;
use TillPayments\Client\Transaction\Refund;
use TillPayments\Client\Transaction\Register;
use TillPayments\Client\Transaction\Result;
use TillPayments\Client\Transaction\VoidTransaction;
use TillPayments\Client\Xml\Generator;
use TillPayments\Client\Xml\Parser;
...
class Client {
     ...
     */
    const DEFAULT_GATEWAY_URL = 'https://gateway.tillpayments.com/';
     ...
     * @var string
     */
    protected static $gatewayUrl = 'https://gateway.tillpayments.com/';
     ...
     *
     * @param \TillPayments\Client\Transaction\VoidTransaction $transactionData
     *
     * @return Result
     * @throws ClientException
     * @throws InvalidValueException
