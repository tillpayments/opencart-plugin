...
final class ControllerExtensionPaymentTillPaymentsCreditCard extends Controller
{
    ...
    {
        $this->load->language('extension/payment/till_payments_creditcard');
        ...
        $data['action'] = $this->url->link('extension/payment/till_payments_' . $this->type, 'user_token=' . $this->session->data['user_token'], true);
        ...
        $this->response->setOutput($this->load->view('extension/payment/till_payments', $data));
    }
    ...
    private function getBreadcrumbData()
    {
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('extension/payment/till_payments_' . $this->type, 'user_token=' . $this->session->data['user_token'], true),
        ];
    ...
    {
        if (!$this->user->hasPermission('modify', 'extension/payment/till_payments_' . $this->type)) {
